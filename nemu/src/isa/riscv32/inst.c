...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  */ 
  ...
  INSTPAT("000000 000000 00000 000 00000 1110011",ecall,I,uint32_t dnpc = isa_raise_intr(11,cpu.pc);s->dnpc = dnpc);
  ...
  */
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11",mret,R,s->dnpc = csr_read(0x341);MRET());
