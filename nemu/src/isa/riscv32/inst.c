...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)         \
  ...
  */ 
  ...
  INSTPAT("000000 000000 00000 000 00000 1110011",ecall,I,mode = MODE_M;uint32_t dnpc = isa_raise_intr((mode==MODE_M?11:8),cpu.pc);/*printf("dnpc:%8x\n",dnpc);Mw(R(0),4,1);*/s->dnpc = dnpc);
  ...
  */
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11",mret,R,s->dnpc = csr_read(1);mode = MODE_U);
